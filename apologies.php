...
$nature = array('uma invenção ', 'uma estratégia ', 'uma manobra ', 'uma bandeira ', 'um golpe ',	'um teoria ', 'um ato de ódio ','uma tática');
...
$reason = array('para ameaçar ', 'para desorganizar ', 'para desmoralizar ',	'para destruir ', 'para controlar ', 'para subverter ',
