...
nature = ['uma invensão ', 'uma estratégia ', 'uma manobra ', 'uma bandeira ', 'um golpe ',	'um teoria ', 'um ato de ódio ','uma tática ']

guilty = ['do FHC ', 'dos almofadinhas ', 'da elite branca ', 'do PIG ', 'da oposição ', 'do Olavo de Carvalho ', 'dos coxinhas ',			
...
reason = ['para ameassar ', 'para desorganizar ', 'para desmoralizar ',	'para destruir ', 'para controlar ', 'para subverter ',
